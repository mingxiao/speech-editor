...
import org.eclipse.jdt.internal.ui.text.java.JavaCompletionProcessor;  //real suggestion engine
...
public class JavaSourceViewerConfiguration extends SourceViewerConfiguration {
	...
	public JavaEditor je;
	/**
	 * Default constructor.
	 */
	public JavaSourceViewerConfiguration(JavaEditor je) {
		this.je=je;
	}
	...
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new JavaCompletionProcessor(je, assistant, IDocument.DEFAULT_CONTENT_TYPE), IDocument.DEFAULT_CONTENT_TYPE);
